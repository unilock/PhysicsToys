...
public class Rayon {
	...
	public static void initialize() {
		...
		ServerEvents.Lifecycle.JOIN.register(player -> {
			ServerNetworking.send(player, new Identifier(MODID, "i_have_rayon"), buf -> {});
		});
	}
	...
	public static void initializeClient() {
		...
		// Rayon Server Detection
		PacketRegistry.registerClientbound(new Identifier(MODID, "i_have_rayon"), ctx -> serverHasRayon = true);
